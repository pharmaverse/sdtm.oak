...
test_that("assert_cl() works as expected", {
  ...
  expect_error(assert_cl(ct = NULL, cl = NULL, optional = FALSE))

  # If `cl` is not supplied but it is optional, then all fine.
  expect_no_error(assert_cl(ct = NULL, cl = NULL, optional = TRUE))
  ...
  expect_error(assert_cl(ct = NULL, cl = "C71113", optional = FALSE))
  expect_error(assert_cl(ct = NULL, cl = "C71113", optional = TRUE))

  # If `ct` is supplied but `cl` is NULL, then err if `cl` is not optional, or
  # return `cl` invisibly.
  expect_error(assert_cl(ct = ct, cl = NULL, optional = FALSE))
  expect_no_error(assert_cl(ct = ct, cl = NULL, optional = TRUE))
  ...
  expect_error(assert_cl(ct = ct, cl = "foo", optional = FALSE))
  expect_error(assert_cl(ct = ct, cl = "", optional = FALSE))

  expect_error(assert_cl(ct = ct, cl = NA_character_, optional = FALSE))
  expect_error(assert_cl(ct = ct, cl = NA_character_, optional = TRUE))

  expect_identical(assert_cl(ct = ct, cl = "C71113", optional = FALSE), "C71113")
  expect_identical(assert_cl(ct = ct, cl = "C66726", optional = FALSE), "C66726")
  expect_identical(assert_cl(ct = ct, cl = "C71113", optional = TRUE), "C71113")
  expect_identical(assert_cl(ct = ct, cl = "C66726", optional = TRUE), "C66726")
...
test_that("assert_cl(): when ct is empty", {
  ...
  expect_error(assert_cl(ct = ct, cl = "C71113", optional = FALSE))
  expect_error(assert_cl(ct = ct, cl = "C71113", optional = TRUE))
